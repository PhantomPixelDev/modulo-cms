...
const Posts: React.FC<PostsProps> = (props) => {
  // Debug and provide default values to prevent undefined errors
  console.log('Posts component props:', props);
  
  const { posts, pagination, theme, site, menus } = props || {};
  const safePosts = posts || { data: [] };
  const safePagination = pagination || { current_page: 1, last_page: 1, per_page: 12, total: 0 };
  const safeTheme = theme || { name: 'Modern React', slug: 'modern-react', version: '1.0.0', colors: { primary: '#3b82f6' } };
