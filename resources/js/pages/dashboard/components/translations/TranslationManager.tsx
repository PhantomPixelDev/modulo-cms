                            ...
                            <SelectContent>
                                {localeOptions.map((locale) => (
                                    <SelectItem key={locale.code} value={locale.code}>
                                        ...
                                        {locale.native_name && <span className="ml-2 text-xs text-muted-foreground">{locale.native_name}</span>}
                                    </SelectItem>
                                ))}
                            </SelectContent>
                        </Select>
                            ...
                            {rows.map((entry) => {
                                ...
                                return (
                                    <TableRow key={entry.key}>
                                        ...
                                        <TableCell className="align-top text-sm whitespace-pre-wrap text-muted-foreground">
