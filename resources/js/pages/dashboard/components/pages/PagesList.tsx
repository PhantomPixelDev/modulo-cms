...
export function PagesList({ pages, canEdit = false, canDelete = false, onEdit, onDelete }: PagesListProps) {
    ...
    if (!pages || pages.length === 0) {
        return <EmptyState title={t('dashboard.pages.empty.title')} description={t('dashboard.pages.empty.description')} />;
    }
    ...
    return <DataTable data={pages} columns={columns} actions={actions} itemsPerPage={10} searchFields={['title']} />;
}
