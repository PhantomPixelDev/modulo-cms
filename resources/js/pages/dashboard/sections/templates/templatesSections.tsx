                ...
                <TemplateForm
                    ...
                    onSubmit={(payload) => {
                        ...
                        router[method](url, payload, {
                            preserveScroll: true,
                            onSuccess: () => {
                                showSuccess(t(isEditing ? 'dashboard.templates.messages.updated' : 'dashboard.templates.messages.created'));
                                router.visit(ROUTE.templates.index());
                            },
                            onError: () =>
                                showError(t(isEditing ? 'dashboard.templates.messages.update_failed' : 'dashboard.templates.messages.create_failed')),
                        });
                    }}
