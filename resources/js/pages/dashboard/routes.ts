...
export const ROUTE = {
    posts: {
        ...
        update: (identifier: number | string | { post: number | string }) => route('dashboard.admin.posts.update', postParam(identifier)),
    ...
    users: {
        ...
        roles: {
            assign: (userId: number | string, roleId: number | string) => route('dashboard.admin.users.roles.assign', { user: userId, role: roleId }),
            remove: (userId: number | string, roleId: number | string) => route('dashboard.admin.users.roles.remove', { user: userId, role: roleId }),
        },
    },
    roles: {
    ...
    siteSettings: {
        index: (group?: string) => (group ? route('dashboard.admin.settings.index', { group }) : route('dashboard.admin.settings.index')),
    ...
    translations: {
        index: (params?: { locale?: string; domain?: string; q?: string }) => {
            ...
            return Object.keys(query).length ? route('dashboard.admin.translations.index', query) : route('dashboard.admin.translations.index');
        },
